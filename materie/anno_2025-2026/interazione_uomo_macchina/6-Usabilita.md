...
+ Utenti/numero utenti
	+ Problema del campionamento degli utenti: fare un testo su un app per i medici e su 3000 medici in FVG ne prendo gli unici 30 che sono entusiasti della VR: non sarebbe rappresentativo della classe.
...
+ l'effect size è small sotto lo 0,2: c'è iccola differenza che non si vede ad occhio nudo
...
+ Questionari (self-report)
	+ Vari tipi di questionari:
		...
		+ **A scala di risposta** (es. scala di Likert con un tot di valori, con gli estremi della scala vanno da "fortemente in disaccordo" a ""fortemente d'accordo")
